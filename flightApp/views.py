...
def searchFlights(request):
    flights = Flight.objects.filter(departurelCity= request.data['departurelCity'],arrivallCity= request.data['arrivallCity'])
...
class  PasserngerViewSet(viewsets.ModelViewSet):
